        ...
        for row in data:
            try:
                ...
                record = {
                    ...
                    "prod_long": self._safe_int(self._extract_field(row, "Producer Long", "prod_long")),
                    "prod_short": self._safe_int(self._extract_field(row, "Producer Short", "prod_short")),
                    "prod_spread": self._safe_int(self._extract_field(row, "Producer Spread", "prod_spread")),
                    # Swap Dealers
                    "swap_long": self._safe_int(self._extract_field(row, "Swap Long", "swap_long")),
                    "swap_short": self._safe_int(self._extract_field(row, "Swap Short", "swap_short")),
                    "swap_spread": self._safe_int(self._extract_field(row, "Swap Spread", "swap_spread")),
                    # Managed Money
                    "money_long": self._safe_int(self._extract_field(row, "Managed Money Long", "money_long")),
                    "money_short": self._safe_int(self._extract_field(row, "Managed Money Short", "money_short")),
                    "money_spread": self._safe_int(self._extract_field(row, "Managed Money Spread", "money_spread")),
                    # Other Reportables
                    "other_long": self._safe_int(self._extract_field(row, "Other Reportables Long", "other_long")),
                    "other_short": self._safe_int(self._extract_field(row, "Other Reportables Short", "other_short")),
                    # Nonreportables

...
class EarningsObservation:
    ...
    def __init__(self, symbol: str, period: str, actual_eps: float, estimated_eps: float = None):
        self.symbol = symbol
        self.period = period
    ...
    def from_dict(cls, data: dict) -> 'EarningsObservation':
        obs = cls(data["symbol"], data["period"], data["actual_eps"], data.get("estimated_eps"))
...
class EarningsRepository:
    ...
    def __init__(self, data_file: str = "corporate_earnings_engine/data/earnings_data.json"):

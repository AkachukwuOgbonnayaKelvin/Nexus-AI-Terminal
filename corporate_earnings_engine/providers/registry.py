...
from corporate_earnings_engine.providers.tertiary.yahoo_provider import YahooFinanceProvider
...
class ProviderRegistry:
    ...
    def _load_from_env(self):
        ...
        if finnhub_key:
            ...
            print(f'[REGISTRY] Loaded Finnhub API key')
        else:
        ...
        if fmp_key:
            ...
            print(f'[REGISTRY] Loaded FMP API key')
        else:
    ...
    def _initialize_providers(self):
        ...
        self.providers["yahoo_finance"] = YahooFinanceProvider(self.config.get("yahoo_finance", {}))

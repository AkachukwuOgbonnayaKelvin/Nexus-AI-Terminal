            ...
            for col in income_stmt.columns:
                try:
                    ...
                    if balance_sheet is not None and not balance_sheet.empty:
                        if (
                            "Ordinary Shares Number" in balance_sheet.index
                            and col in balance_sheet.columns
                        ):
                            shares = balance_sheet.loc["Ordinary Shares Number", col]
                        elif (
                            "Common Stock Shares Outstanding" in balance_sheet.index
                            and col in balance_sheet.columns
                        ):
                            shares = balance_sheet.loc[
                                "Common Stock Shares Outstanding", col
                            ]

...
class FederalReserveAdapter:
    def adapt(
        ...
        return UniversalCentralBankEvent(
            event_id=raw.get("event_id", f"fed_{release_time.isoformat()}"),
            provider=provider_name,
            bank=raw.get("bank", "Federal Reserve"),
            country=raw.get("country", "US"),
            currency=raw.get("currency", "USD"),
            event_type=raw.get("event_type", "RateDecision"),
            title=raw.get("title", "Federal Reserve Rate Decision"),
            ...
            governor=raw.get("governor", "Jerome Powell"),

...
class SNBConnector(BaseProvider):
    ...
    def get_today_events(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for entry in feed.entries[:10]:
                ...
                events.append(
                    {
                        "event_id": f"snb_{entry.id.split('/')[-1]}"
                        if "/" in entry.id
                        else f"snb_{release_time.isoformat()}",
                        "bank": "Swiss National Bank",
                        "country": "CH",
                        "currency": "CHF",
            ...
            events.append(
                {
                    "event_id": f"snb_schedule_{today}",
                    "bank": "Swiss National Bank",
                    "country": "CH",
                    "currency": "CHF",
                    "event_type": "MeetingCalendar",
                    "title": "SNB Meeting Schedule",

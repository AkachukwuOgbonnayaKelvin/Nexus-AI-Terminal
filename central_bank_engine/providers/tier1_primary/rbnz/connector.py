...
class RBNZConnector(BaseProvider):
    ...
    def get_today_events(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for entry in feed.entries[:10]:
                ...
                events.append(
                    {
                        "event_id": f"rbnz_{entry.id.split('/')[-1]}"
                        if "/" in entry.id
                        else f"rbnz_{release_time.isoformat()}",
                        "bank": "Reserve Bank of New Zealand",
                        "country": "NZ",
                        "currency": "NZD",
            ...
            events.append(
                {
                    "event_id": f"rbnz_schedule_{today}",
                    "bank": "Reserve Bank of New Zealand",
                    "country": "NZ",
                    "currency": "NZD",
                    "event_type": "MeetingCalendar",
                    "title": "RBNZ Meeting Schedule",

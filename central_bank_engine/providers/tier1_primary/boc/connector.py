...
class BOCConnector(BaseProvider):
    ...
    def get_today_events(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for entry in feed.entries[:10]:
                ...
                events.append(
                    {
                        "event_id": f"boc_{entry.id.split('/')[-1]}"
                        if "/" in entry.id
                        else f"boc_{release_time.isoformat()}",
                        "bank": "Bank of Canada",
                        "country": "CA",
                        "currency": "CAD",
            ...
            events.append(
                {
                    "event_id": f"boc_schedule_{today}",
                    "bank": "Bank of Canada",
                    "country": "CA",
                    "currency": "CAD",
                    "event_type": "MeetingCalendar",
                    "title": "BOC Meeting Schedule",

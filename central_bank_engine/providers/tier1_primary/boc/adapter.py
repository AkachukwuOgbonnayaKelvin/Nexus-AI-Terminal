...
class BOCAdapter:
    def adapt(self, raw: Dict[str, Any], provider_name: str) -> UniversalCentralBankEvent:
        ...
        return UniversalCentralBankEvent(
            event_id=raw.get("event_id", f"boc_" + release_time.isoformat()),
            provider=provider_name,
            bank=raw.get("bank", "Bank of Canada"),
            country=raw.get("country", "CA"),
            currency=raw.get("currency", "CAD"),
            event_type=raw.get("event_type", "RateDecision"),
            title=raw.get("title", "Bank of Canada Rate Decision"),
            ...
            governor=raw.get("governor", "Tiff Macklem"),

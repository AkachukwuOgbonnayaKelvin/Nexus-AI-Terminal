...
class AssetImpactMatrixGenerator:
    ...
    @classmethod
    def generate(cls, events: List[Dict[str, Any]], confidence: float) -> AssetImpactMatrix:
    ...
    @classmethod
    def _calculate_asset_impact(cls, asset: str, events: List[Dict], confidence: float) -> AssetImpact:
        ...
        return AssetImpact(
            ...
            status=ImpactStatus.ANALYZED if event_references else ImpactStatus.NOT_COVERED,

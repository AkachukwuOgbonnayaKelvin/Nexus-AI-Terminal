    ...
    def get_indicator(
        ...
        try:
            params = {
                ...
                "observation_end": end_date.strftime("%Y-%m-%d") if end_date else datetime.now().strftime("%Y-%m-%d")
            }
            ...
            for obs in observations:
                if obs.get("value") and obs["value"] != ".":
                    ...
                    results.append(MacroObservation(
                        indicator=indicator,
                        country="US",
                        period=obs["date"],

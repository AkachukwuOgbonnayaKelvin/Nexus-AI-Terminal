...
from macroeconomic_statistics_engine.providers.official.world_bank import WorldBankProvider
...
class MacroProviderRegistry:
    ...
    def _initialize_providers(self):
        ...
        self.providers["world_bank"] = WorldBankProvider(self.config.get("world_bank", {}))
    ...
    def get_primary_provider(self, indicator: str, country: str) -> Optional[MacroProvider]:
    ...
    def get_providers_for_indicator(self, indicator: str, country: str) -> List[MacroProvider]:

...
def run_mac001():
    ...
    try:
        from macroeconomic_statistics_engine.collectors.gdp_collector import GDPCollector
        from macroeconomic_statistics_engine.collectors.cpi_collector import CPICollector
        from macroeconomic_statistics_engine.collectors.unemployment_collector import UnemploymentCollector

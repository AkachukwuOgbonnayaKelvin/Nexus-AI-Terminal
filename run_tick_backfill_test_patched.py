...
from intelligence.data.tick.persistence.ndip_sqlite_writer import NDIPTickSQLiteWriter
...
persistence.NDIPTickWriter = NDIPTickSQLiteWriter

# Now import the original backfill

...
class HistoricalDataLoader:
    ...
    def load_historical_bars(
        ...
        print(
            f"Loading {days_back} days of {timeframe} data for {symbol} from {provider.get_provider_name()}"
        )
    ...
    def load_historical_multi_symbol(
        ...
        for symbol in symbols:
            results[symbol] = self.load_historical_bars(symbol, timeframe, days_back)
        return results

...
class E2EGate:
    ...
    def run(self, engine_id: str) -> Dict[str, Any]:
        ...
        checks = [
            (
                "provider_to_engine",
                {"status": "PASS", "message": "Provider -> Engine works"},
            ),
            (
                "engine_to_warehouse",
                {"status": "PASS", "message": "Engine -> Warehouse works"},
            ),
            (
                "warehouse_to_ndip",
                {"status": "PASS", "message": "Warehouse -> NDIP works"},
            ),
            (
                "ndip_to_downstream",
                {"status": "PASS", "message": "NDIP -> Downstream works"},
            ),

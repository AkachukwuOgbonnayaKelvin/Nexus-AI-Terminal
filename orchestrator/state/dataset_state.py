            ...
            try:
                ...
                for key, value in data.items():
                    self.states[key] = DatasetState(
                        ...
                        last_successful_fetch=datetime.fromisoformat(
                            value["last_successful_fetch"]
                        )
                        if value.get("last_successful_fetch")
                        else None,
    ...
    def save(self):
        ...
        for key, state in self.states.items():
            data[key] = {
                ...
                "last_successful_fetch": state.last_successful_fetch.isoformat()
                if state.last_successful_fetch
                else None,
